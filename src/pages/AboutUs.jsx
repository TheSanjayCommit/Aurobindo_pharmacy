...
//       {/* Hero Section */}
//       <section className="relative bg-gradient-to-br from-orange-50 via-white to-orange-50 py-16 overflow-hidden">
//         <div className="container mx-auto px-4">
//           <div className="text-center max-w-3xl mx-auto">
//             <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
//               About <span className="text-orange-600">Aurobindo Dental Hospital</span>
//             </h1>
...
//                 <div
//                   key={index}
//                   className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-orange-100 text-center"
//                 >
...
//           <div className="text-center mb-12">
//             <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
//               Our Expert <span className="text-orange-600">Consultants</span>
//             </h2>
...
//               <div
//                 key={index}
//                 className="bg-gradient-to-br from-white to-orange-50 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-orange-100 text-center group hover:scale-105"
//               >
//                 <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden border-3 border-orange-200 shadow-md group-hover:border-orange-400 transition-colors">
//                   <img
//                     src={doctor.image}
//                     alt={doctor.name}
...
//                   <p className="text-orange-600 font-semibold text-sm">{doctor.qualification}</p>
//                 </div>
