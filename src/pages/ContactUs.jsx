        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md border border-blue-100">
                ...
                <div className="flex items-start space-x-4 p-6 bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md border border-blue-100">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">Phone</h3>
                    <div className="space-y-1">
                      <a href="tel:9866937777" className="block text-blue-600 hover:underline">9866937777</a>
                      <a href="tel:9032018887" className="block text-blue-600 hover:underline">9032018887</a>
                      <a href="tel:9347294612" className="block text-blue-600 hover:underline">9347294612</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md border border-blue-100">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">Email</h3>
                    <a href="mailto:aurobindodental@gmail.com" className="text-blue-600 hover:underline">
                      aurobindodental@gmail.com
                    </a>
                  </div>
                </div>
