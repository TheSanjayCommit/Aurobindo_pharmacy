  ...
  const treatments = [
    {
      ...
      title: "ENDODONTICS",
      image:
        "https://images.pexels.com/photos/3762408/pexels-photo-3762408.jpeg?w=600&q=80",
      content: `Endodontics deals with the dental pulp and tissues around the root of a tooth. It includes root canal treatments that save infected teeth. Our specialists ensure gentle and precise care for long-lasting results.`,
    },
    {
      id: "pedodontics",
      icon: Baby,
      ...
      content: `Pedodontics focuses on children’s dental health, ensuring healthy development from infancy through adolescence. We provide a fun, safe, and comforting environment for every child.`,
    },
    {
      id: "orthodontics",
      icon: Smile,
      title: "ORTHODONTICS",
      image:
        "https://images.pexels.com/photos/3762453/pexels-photo-3762453.jpeg?w=600&q=80",
      content: `Orthodontics corrects teeth alignment and bite issues through braces and clear aligners. We help you achieve a confident, natural smile using advanced digital alignment techniques.`,
    },
    {
      id: "cosmetic",
      icon: Sparkles,
      title: "COSMETIC DENTISTRY",
      image:
        "https://images.unsplash.com/photo-1654373535457-383a0a4d00f9?w=600&q=80",
      content: `Enhance your smile with teeth whitening, veneers, and smile makeovers. Our cosmetic specialists design your ideal smile with artistry and precision.`,
    },
    {
      id: "periodontics",
      icon: Shield,
      ...
      content: `Healthy gums are the foundation of a healthy mouth. We prevent and treat gum diseases, perform implant procedures, and offer advanced gum care treatments.`,
    },
    {
      id: "oral-surgery",
      icon: Scissors,
      ...
      content: `Our expert surgeons handle tooth extractions, dental implants, and corrective jaw surgeries with utmost safety and care.`,
    },
    {
      id: "prosthodontics",
      icon: Wrench,
      ...
      content: `We specialize in restoring your smile through crowns, bridges, dentures, and implants, ensuring comfort and aesthetics.`,
    },
    {
      id: "implants",
      icon: Zap,
      title: "DENTAL IMPLANTS",
      image:
        "https://images.unsplash.com/photo-1643660526741-094639fbe53a?w=600&q=80",
      content: `Dental implants provide a strong and natural-looking solution for missing teeth — offering long-term comfort and confidence.`,
    },
    {
      id: "oral-medicine",
      icon: Stethoscope,
      ...
      content: `We use advanced diagnostic imaging to detect and treat oral diseases, ensuring accurate and effective treatment planning.`,
    },
  ];

  return (
    <div className="treatments-page bg-gradient-to-b from-white via-blue-50 to-cyan-50">
      {/* Hero Section */}
      <section className="py-16 text-center">
        <div className="container mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-4">
            Our Dental{" "}
            <span className="text-sky-600">Treatments & Specialties</span>
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience expert care, modern technology, and a patient-first
            approach at our state-of-the-art dental center.
          </p>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            "https://images.unsplash.com/photo-1667133295308-9ef24f71952e?w=400&q=80",
            "https://images.pexels.com/photos/3762453/pexels-photo-3762453.jpeg?w=400&q=80",
            "https://images.unsplash.com/photo-1654373535457-383a0a4d00f9?w=400&q=80",
          ].map((src, i) => (
            <div
              key={i}
            ...
            {treatments.map((treatment) => {
              ...
              return (
                <AccordionItem
                  key={treatment.id}
                  value={treatment.id}
                  className="bg-gradient-to-br from-white to-blue-50 border border-blue-100 rounded-2xl shadow-sm hover:shadow-md transition-all"
                >
                  <AccordionTrigger className="px-6 py-5 hover:bg-blue-50 rounded-t-2xl">
                    <div className="flex items-center space-x-4">
                  ...
                  <AccordionContent className="px-6 py-5 bg-gradient-to-br from-white to-blue-50 rounded-b-2xl">
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="md:w-1/3">
                        <img
                          src={treatment.image}
